...
pub fn t(lang: Lang, key: Key) -> &'static str {
    ...
    match (key, lang) {
        ...
        (ConfirmEnroll, En) => "Enable two-factor",
        (ConfirmEnroll, Tr) => "İki faktörlüyü aç",
        ...
        (Activate2fa, En) => "Activate two-factor",
        (Activate2fa, Tr) => "İki faktörlüyü etkinleştir",
        (AdminChip, En) => "Admin",
        ...
        (ServicesStorageLimit, En) => "Storage limit",
        (ServicesStorageLimit, Tr) => "Depolama limiti",
        ...
        (AppsEmpty, En) => "No apps are connected yet.",
        (AppsEmpty, Tr) => "Henüz bağlı uygulama yok.",
        (ClientIdLabel, En) => "Client ID",
        (ClientIdLabel, Tr) => "İstemci kimliği",
        (ActiveGrantsLabel, En) => "Active grants",
        (ActiveGrantsLabel, Tr) => "Etkin yetkiler",
        (LastConnectedLabel, En) => "Last connected",
        (LastConnectedLabel, Tr) => "Son bağlanma",
        ...
        (NavHealth, En) => "Health",
        (NavHealth, Tr) => "Sağlık",
        (HealthTitle, En) => "Family health",
        (HealthTitle, Tr) => "Aile sağlığı",
        (HealthStateCol, En) => "State",
        (HealthStateCol, Tr) => "Durum",
        (HealthUnreachable, En) => "Unreachable",
        (HealthUnreachable, Tr) => "Erişilemiyor",
        ...
        (MaxSessionsLabel, En) => "Sign-in sessions per user",
        (MaxSessionsLabel, Tr) => "Kullanıcı başına oturum",
